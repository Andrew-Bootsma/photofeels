...
1. Run `npm i` to install your copy of `/node_modules'

2. You will need to create a `.env.local` file in the root of the application after forking. Add a `REACT_APP_UNSPLASH_CLIENT_ID='YOUR-ID-GOES-HERE'` variable to the file. Replace `YOUR-ID-GOES-HERE` with an Unsplash client id generated by creating an account here --> https://unsplash.com/developers.
...
- I couldn't resist a few minutes of graphic design to create my own logo

### If I had more time
- I would finish all of the testing, I wanted to focus on what I am best at first which is why I left testing for the end
...
- I installed SASS
  - I used BEM for my classNames
  - I used a simpler architecture than 7-1 because its a small application
  - It is fully responsive on all of the screens I tested
- I used the Context API instead of Redux because its a small application
